...
def _build_script_prompt_v2(theme, length, notes, mode="safe",
    ...
    parts += [
        ...
        "- flashback / visionNoise / impactLines / zoomPunch / quoteFreeze / voiceLines / reactionMark / irisOut / stampRain / typingFlood / sparkleBurst を turn 直下に書かない（対応済みの演出は effects の中に書く）",
