...
def _build_script_prompt(theme, length, notes, mode="safe",
    ...
    parts = [
        ...
        '- "pose": "idle" / "cheer" / "recoil" / "lean" / "droop" / "flustered" / "proud" / "step_in" / "step_back" / "listening" / "sneak" / "whisper" / "wobble" / "point" … その行の話者ポーズ',
...
def _build_script_prompt_v2(theme, length, notes, mode="safe",
    ...
    parts = [
        ...
        '【pose】idle / cheer / recoil / lean / droop / flustered / proud / step_in / step_back / listening / sneak / whisper / wobble / point',
